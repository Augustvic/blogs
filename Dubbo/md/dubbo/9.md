...
> 1. [服务暴露](https://github.com/Augustvic/Blogs/tree/master/Dubbo/md/dubbo/3.md)、[服务引入](https://github.com/Augustvic/Blogs/tree/master/Dubbo/md/dubbo/4.md)、[目录和路由](https://github.com/Augustvic/Blogs/tree/master/Dubbo/md/dubbo/5.md)、[集群容错](https://github.com/Augustvic/Blogs/tree/master/Dubbo/md/dubbo/7.md)、[负载均衡](https://github.com/Augustvic/Blogs/tree/master/Dubbo/md/dubbo/8.md) 等内容请参考前面的内容。
> 2. Netty 组件和数据编解码过程的相关内容请参考 [Dubbo 协议与通信过程](https://github.com/Augustvic/Blogs/tree/master/Dubbo/md/dubbo/12.md) 。
> 3. 过滤器链的相关内容请参考 [过滤器链](https://github.com/Augustvic/Blogs/tree/master/Dubbo/md/dubbo/13.md) 。
> 4. 异步请求和响应的相关内容请参考 [异步调用和线程模型](https://github.com/Augustvic/Blogs/tree/master/Dubbo/md/dubbo/14.md) 。

## 9.1 调用服务

一次简单的调用主要经过了以下流程：

<img src="https://github.com/Augustvic/Blogs/blob/master/Dubbo/images/invoke.png" width=50% />
...
调用过程从代理类开始，在 [服务引入](https://github.com/Augustvic/Blogs/tree/master/Dubbo/md/dubbo/4.md) 一节中已经阐述过创建代理类的过程。
...
在 [服务引入](https://github.com/Augustvic/Blogs/tree/master/Dubbo/md/dubbo/4.md) 一节中谈到将服务提供者 invoker 通过 cluster.join 聚合成一个 invoker，默认为 FailoverClusterInvoker（FailoverClusterInvoker 外面会包装一层 MockClusterInvoker），接着调用 FailoverClusterInvoker 的 invoke 方法，将会经过集群容错机制、负载均衡选择器和过滤器，到达代表服务提供者的 DubboInvoker。
...
在 [服务暴露](https://github.com/Augustvic/Blogs/tree/master/Dubbo/md/dubbo/3.md) 一节中已经描述了创造 Invoker 的流程。此时只需要根据 Channel 和 Invocation 构造 key，根据 key 在 exporterMap 中查找，如果没找到则抛出异常。
